...
namespace AspireApp.ApiService.Domain.Notifications.Services;
...
public static class NotificationLocalization
{
    ...
    /// </summary>
    public static Interfaces.LocalizedNotificationContent GetContent(
        string language,
        string titleKey,
        string bodyKey,
        ...
        params object[] args)
    {
        ...
        return new Interfaces.LocalizedNotificationContent
        {
            Title = title,
            Body = body,
            Language = language,
    ...
    private static void LoadResources()
    {
        ...
        var possiblePaths = new[]
        {
            ...
            Path.Combine(baseDirectory, "src", "AspireApp.ApiService.Domain", "Notifications", "Resources"),
            Path.Combine(Directory.GetCurrentDirectory(), "Resources"),
            Path.Combine(Directory.GetCurrentDirectory(), "src", "AspireApp.ApiService.Domain", "Notifications", "Resources"),
            Path.Combine(baseDirectory, "Notifications", "Resources"),
            Path.Combine(Directory.GetCurrentDirectory(), "Notifications", "Resources")
        };
    ...
    {
        public static Interfaces.LocalizedNotificationContent NewRequest(string language, string userName, string facilityCode, string? actionUrl = null)
        {
            return GetContent(language, "FacilityRequest_New_Title", "FacilityRequest_New_Body", actionUrl, userName, facilityCode);
        }

        public static Interfaces.LocalizedNotificationContent Approved(string language, string facilityName, string facilityCode, string? actionUrl = null)
        {
        ...
        public static Interfaces.LocalizedNotificationContent Rejected(string language, string facilityName, string facilityCode, string? actionUrl = null)
        {
    ...
    {
        public static Interfaces.LocalizedNotificationContent NewReport(string language, string patientName, string? actionUrl = null)
        {
            return GetContent(language, "TestReport_New_Title", "TestReport_New_Body", actionUrl, patientName);
        }

        public static Interfaces.LocalizedNotificationContent Completed(string language, string patientName, string? actionUrl = null)
        {
    ...
    {
        public static Interfaces.LocalizedNotificationContent Registration(string language, string userName, string? actionUrl = null)
        {
            return GetContent(language, "User_Registration_Title", "User_Registration_Body", actionUrl, userName);
        }

        public static Interfaces.LocalizedNotificationContent PasswordReset(string language, string? actionUrl = null)
        {
    ...
    {
        public static Interfaces.LocalizedNotificationContent Maintenance(string language, string startTime, string? actionUrl = null)
        {
            return GetContent(language, "System_Maintenance_Title", "System_Maintenance_Body", actionUrl, startTime);
        }

        public static Interfaces.LocalizedNotificationContent EmergencyAlert(string language, string location, string? actionUrl = null)
        {
    ...
    {
        public static Interfaces.LocalizedNotificationContent Reminder(string language, string appointmentTime, string? actionUrl = null)
        {
    ...
    {
        public static Interfaces.LocalizedNotificationContent Received(string language, string amount, string? actionUrl = null)
        {
    ...
    {
        public static Interfaces.LocalizedNotificationContent Expired(string language, string documentName, string? actionUrl = null)
        {
    ...
    {
        public static Interfaces.LocalizedNotificationContent LowWarning(string language, int available, int total, string? actionUrl = null)
        {
    ...
    {
        public static Interfaces.LocalizedNotificationContent Redeemed(string language, string doctorName, string? actionUrl = null)
        {
