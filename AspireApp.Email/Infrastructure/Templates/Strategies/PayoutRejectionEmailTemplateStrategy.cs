...
/// <summary>
/// Strategy implementation for payout rejection email templates
/// </summary>
public class PayoutRejectionEmailTemplateStrategy : IPayoutRejectionEmailTemplateStrategy
{
    private readonly string _applicationTitle;

    public PayoutRejectionEmailTemplateStrategy(IOptions<EmailOptions> emailOptions)
    {
