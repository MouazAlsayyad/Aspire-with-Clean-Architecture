        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageBody = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: false),
                    Channel = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    MessageSid = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SentAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeliveredAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FailedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FailureReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    TemplateId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TemplateVariables = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DeletionTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileUpload_CreationTime",
                table: "FileUpload",
                column: "CreationTime");

            migrationBuilder.CreateIndex(
                name: "IX_FileUpload_FileName",
                table: "FileUpload",
                column: "FileName");

            migrationBuilder.CreateIndex(
                name: "IX_FileUpload_FileType",
                table: "FileUpload",
                column: "FileType");

            migrationBuilder.CreateIndex(
                name: "IX_FileUpload_Hash",
                table: "FileUpload",
                column: "Hash");

            migrationBuilder.CreateIndex(
                name: "IX_FileUpload_StorageType",
                table: "FileUpload",
                column: "StorageType");

            migrationBuilder.CreateIndex(
                name: "IX_FileUpload_StorageType_FileType",
                table: "FileUpload",
                columns: new[] { "StorageType", "FileType" });

            migrationBuilder.CreateIndex(
                name: "IX_FileUpload_UploadedBy",
                table: "FileUpload",
                column: "UploadedBy");

            migrationBuilder.CreateIndex(
                name: "IX_FileUpload_UploadedBy_CreationTime",
                table: "FileUpload",
