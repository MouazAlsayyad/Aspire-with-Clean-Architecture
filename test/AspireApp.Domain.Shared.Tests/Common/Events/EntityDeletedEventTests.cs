...
public class EntityDeletedEventTests
{
    ...
    public void Constructor_ShouldSetAllProperties()
    {
        ...
        // Act
        var evt = new EntityDeletedEvent(entityId, entityType, properties);
    ...
    public void Constructor_WithNullProperties_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new EntityDeletedEvent(entityId, entityType, null!));
    }
    ...
    [Fact]
    public void EntityDeletedEvent_ShouldInheritFromEntityChangedEvent()
    {
        // Arrange
        var entityId = Guid.NewGuid();
        var entityType = "User";
    ...
    [Fact]
    public void EntityDeletedEvent_ShouldHaveOccurredOn()
    {
        // Arrange
    ...
    [Fact]
    public void Properties_ShouldCaptureStateBeforeDeletion()
    {
        // Arrange
        var entityId = Guid.NewGuid();
        var entityType = "User";
        ...
        // Assert
        Assert.Equal(entityId, evt.Properties["Id"]);
        Assert.Equal("deleted@test.com", evt.Properties["Email"]);
        Assert.Equal(false, evt.Properties["IsActive"]);
    }
}
