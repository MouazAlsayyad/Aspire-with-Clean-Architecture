...
public static class EndpointRouteBuilderExtensions
{
    ...
    public static IEndpointRouteBuilder MapEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        // Find all static classes in the Endpoints, Notifications, Twilios, ActivityLogs, FileUploads, Emails, or Payments namespace
        var endpointClasses = presentationAssembly
            ...
            .Where(t => t.IsClass &&
                       ...
                       (t.Namespace?.Contains("Endpoints") == true || 
                        ...
                        t.Namespace?.Contains("Emails") == true ||
                        t.Namespace?.Contains("Payments") == true))
            .ToList();
